...
from KaalX import MK1, MK2, MK3, MK4, MK5 , MK6, MK7, MK8, MK9, MK10, SUDO_USERS, OWNER_ID

from KaalX import CMD_HNDLR as hl
from KaalX.sql.echo_sql import addecho, is_echo, remove_echo
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
            ...
            if int(user_id) in RyanX:
                    text = f"I Can't Echo KaalX's Owner"
